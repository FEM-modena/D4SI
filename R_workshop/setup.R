...
knitr::opts_chunk$set(results='hide', fig.path='D4SI/R_workshop/Workshop1-',
...
knitr::knit_hooks$set(answer = function(before, options, envir) {
        if (before) {
                paste(
                        "<div class=\"accordion\">",
                        "<h3 class=\"toc-ignore\">Risposta</h3>",
...
it_text_answer <- knitr:::eng_html_asset(
        paste(
                "<div class=\"accordion\">",
                "<h3 class=\"toc-ignore\">Risposta</h3>",
...
knitr::knit_engines$set(text_answer = it_text_answer)